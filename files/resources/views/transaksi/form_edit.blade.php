    ...
    <div class="card-body">
        <div class="container px-3 my-0">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-2">
                    <input type="text" name="nama_customer" value="{{ $row->nama_customer }}"
                    class="form-control form-control @error('nama_customer') is-invalid @enderror">
                    @error('nama_customer')
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-5">
                    <select class="form-select form-control" name="status">
                        ...
                        <option @if($row->status==='Proses') selected @endif value="Proses">Proses</option>
                        <option @if($row->status==='Selesai') selected @endif value="Selesai">Selesai</option>
                    </select>
                </div>
            </div>
